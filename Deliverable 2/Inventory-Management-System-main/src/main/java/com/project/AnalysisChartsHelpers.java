...
public class AnalysisChartsHelpers {
    ...
    private static final Logger logger = Logger.getLogger(AnalysisChartsHelpers.class.getName());
    ...
    public void createCategoryBarGraph(JPanel catBarGraphPnl, String year) {
        ...
        for (int i = 0; i < invtTable.getRowCount(); i++) {
            logger.info(invtTable.getValueAt(i, 10).toString());
    ...
    public void createFeesChart(JPanel feesPnl, String year) {
        Map<String, Double> sfMap;
        Map<String, Double> pfMap;
        Map<String, Double> shfMap;
        sfMap = new LinkedHashMap<>(getMonMap());
        pfMap = new LinkedHashMap<>(getMonMap());;
        shfMap = new LinkedHashMap<>(getMonMap());
        String sd;
        String mon;
        Double sf;
        Double pf;
